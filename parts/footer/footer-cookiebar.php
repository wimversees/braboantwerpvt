...
echo sprintf(t('cookie-message', false), $cookiePolicyLink, $privacyPolicyLink); ?></p>
    <p><span class="cookie-accept btn btn-primary" title="<?php t('cookie-ok-title'); ?>" id="cookie-accept"><?php t('cookie-ok'); ?></span><a
            href="<?php echo get_permalink(gpid('page-cookie-policy')); ?>"
            title="<?php echo get_the_title(gpid('page-cookie-policy')); ?>"><?php t('cookie-more-info'); ?></a>
    </p>
</div>
<script async>
