...
wp_nav_menu(array(
    ...
    ?>
            ...
            <div class="col-12 col-md-3 d-flex justify-content-center pb-2">
                ...
                <?php if (c('multilanguage-enabled')) {includecached('parts/languages/language-switcher.php', get_the_ID());} ?>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-7">
                    <p class="footer-copyright-text"><?php t('footer-copyright'); ?> <?php echo date('Y'); ?> <a href="<?php echo bloginfo('url'); ?>"
                            title="<?php echo bloginfo('name'); ?>"><?php echo bloginfo('name'); ?></a>. <?php t('footer-all-rights-reserved'); ?> <a
                            href="https://www.wiver.be" target="_blank" title="Wiver Webdesign & Display Advertising" rel="noreferrer">WIVER</a></p>
                </div>
                <div class="col-12 col-md-5 ml-auto justify-content-center">
                    <ul class="footer-nav">
                        <li class="nav-item">
                            <a href="<?php echo get_permalink(gpid('page-sitemap')); ?>" title="<?php echo get_the_title(gpid('page-sitemap')); ?>"
                                class="nav-link"><?php echo get_the_title(gpid('page-sitemap')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo get_permalink(gpid('page-privacy-policy')); ?>"
                                title="<?php echo get_the_title(gpid('page-privacy-policy')); ?>"
                                class="nav-link"><?php echo get_the_title(gpid('page-privacy-policy')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo get_permalink(gpid('page-cookie-policy')); ?>"
                                title="<?php echo get_the_title(gpid('page-cookie-policy')); ?>"
                                class="nav-link"><?php echo get_the_title(gpid('page-cookie-policy')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php if (IsProEnvironment()) {
    includecached('parts/footer/footer-google-analytics.php');
}
?>
</body>
